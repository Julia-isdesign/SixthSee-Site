...
<html lang="pt-br">
	<head>
		...
		<base href="https://www.seecranes.ind.br/em-breve/">
		...
		<meta name="url" content="https://www.seecranes.ind.br/em-breve">
	...
	<body>
		...
		<main class="l-conteudo l-envelope">

			<div style="width:100%; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:40px;">
				<figure style="width:200px;">
					<img src="https://www.seecranes.ind.br/em-breve/img/logo-seecranes.png" alt="Logo da SEE Cranes" style="width:100%; height:auto;">
				</figure>
